...
<div class="header">
  ...
  <img src="logout.png" alt="logout button" style="width:60px;height:55px;border:0;float:right">
	...
	<form method = "post" action = "AddMovieToTheatre" align = "center">
		...
		<input type = "text" name = "movieId" placeholder = "Enter Movie ID" pattern="^[3]{1}[0-9]{3}$" title="Movie ID should start with number 3 and of only 4 digits"required></br></br>
